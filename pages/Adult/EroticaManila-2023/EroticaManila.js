...
const schemaData   = {
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://uwatch4free.vercel.app/Adult/EroticaManila-2023/EroticaManila "
    
  },
  "headline": "Erotica Manila (2023) | Uwatch4free™",
  "image": "https://uwatch4free.vercel.app/erotica-manila-2023.webp",
  ...
  "description": "Uwatch4free™ Erotica Manila (2023) | Watch now the Best TV shows and Movies"
...
const scrollSearch = myKey => {
  ...
  />
     <Head>
     <title>Watch Erotica Manila (2023) | Uwatch4free™</title>
...
<meta property="og:title" content="Watch Erotica Manila (2023) | Uwatch4free™" />
<meta property="og:url" content="https://uwatch4free.vercel.app/Adult/EroticaManila-2023/EroticaManila/" />
<meta property="og:image" content="https://uwatch4free.vercel.app/erotica-manila-2023.webp" />
...
<link rel="canonical" href="https://uwatch4free.vercel.app/Adult/EroticaManila-2023/" />
    ...
    <iframe className="w-full aspect-w-16 aspect-h-9" src="https://sbbrisk.com/e/iacfq8fxzo59.html" height={550}></iframe>
...
<h2 className=" text-medium font-sm text-center dark:text-white text-white"><strong>Genre:</strong> Adult, Drama & Hot</h2>
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Release year:</strong> 2023</h2>
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Director:</strong> Lawrence Fajardo</h2>
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Country:</strong> USA</h2>
<h2 className="text-medium font-sm text-center dark:text-white text-white "><strong>Starring:</strong> Gie Inducil-Justo, JL Martin, Jheff Felix, Arthur Marquez Valdez, Josef Elizalde, Alex Medina, Vince Rillon, Armando Salonga, Richard Flores, Edgar Ebro, Alon Miralles, Mauro Encencio, Dennis Lucero.</h2>
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Description:</strong>A man enters an adult film theatre, a writer gets a naughty massage, a porn star satisfies an intern, and a couple kill a man while making love.</h2>

  <h2 className="text-4xl font-bold text-center text-white  ">Watch Offical Trailer</h2>
 
    

    <iframe className=" aspect-w-16 aspect-h-9  " src="https://sbbrisk.com/e/6iipk5zovcdf.html"  position="relative"  height={350} ></iframe>
    </div>
