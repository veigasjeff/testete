...
const schemaData   = {
  ...
  "headline": "Gandii Baat Season 7 (2023) | Uwatch4free™",
  ...
  "description": "Uwatch4free™ Gandii Baat Season 7 (2023) | Watch now the Best TV shows and Movies"
...
function togglePopup() {
  ...
  />
     <Head>
     <title>Watch Gandii Baat Season 7 (2023) | Uwatch4free™</title>
...
<link rel="canonical" href="https://uwatch4free.vercel.app/Adult/GandiIBaatS7-2023/" />
   ...
   <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
    <a href="../GandiIBaatS7-2023/GBTSR2" > 
      <h1 >Click To Watch Gandii Baat Season 7 (2023) Server 2</h1></a></button>
...
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Director:</strong> Punit (P.G) - ALTT Originals App</h2>
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Country:</strong> Indian</h2>
<h2 className="text-medium font-sm text-center dark:text-white text-white "><strong>Starring:</strong> Garima Maurya, Basant Kumar, Sreoshi Chatterjee, Jinal Jain, Bhanu Suryam Thakur, Shivangi Roy, Bhavna Rokade, Yash Gera, Manvi Chugh </h2>
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Description:</strong> The plot revolves around multiple individuals and their life during lockdown. They decide to enjoy life in different ways.</h2>
