...
const schemaData   = {
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://uwatch4free.vercel.app/Adult/Kaand-2023/KaandP2"
    
  },
  "headline": "Kaand Episode 2 (2023) | Uwatch4free™",
  ...
  "description": "Uwatch4free™ Kaand Episode 2 (2023) | Watch now the Best TV shows and Movies"
...
const scrollSearch = myKey => {
  ...
  />
     <Head>
     <title>Watch Kaand Episode 2 (2023) | Uwatch4free™</title>
<meta name="robots" content="max-snippet:-1, max-image-preview:large, max-video-preview:-1" />
<meta name="keywords" content="Uwatch4free,streaming,latest movies,online tv,latest free movies,watch latest movies online,index of Kaand Episode 2,Kaand Episode 2 (2023) movie,watch Kaand Episode 2 (2023) movie online,Kaand Episode 2 (2023) movie download,Kaand Episode 2 (2023) movie trailer" />

<meta property="og:locale" content="en_US" />
<meta property="og:site_name" content="Uwatch4free™ | Watch Movies and TV-Series Online Free" />
<meta property="og:type" content="movie" />
<meta property="og:title" content="Watch Kaand Episode 2 (2023) | Uwatch4free™" />
<meta property="og:url" content="https://uwatch4free.vercel.app/Adult/Kaand-2023/KaandP2" />
...
<meta name="twitter:title" content="Watch Kaand Episode 2 (2023) | Uwatch4free™" />
<meta name="twitter:image" content="https://uwatch4free.vercel.app/kaand-2023.webp" />
<meta name="description" content="Watch Kaand Episode 2 Full Movie Online on Uwatch4free™, You can also download Kaand Episode 2 (2023) in full HD quality to watch later offline." />
    ...
    <div className={styles['iframe-container']}>
      <iframe src="https://sbhight.com/e/ww4gn8xmgxhr.html" />
    </div>    
...
<Link href="../../Adult/Kaand-2023/KaandP1">
  ...
  <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-2 mr-2 overflow-hidden text-xl font-bold text-gray-900 rounded-lg group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110 ease-in duration-500 cursor-pointer relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0 " >
    <a href="../Kaand-2023/KADSR2" > 
      <h1 >Click To Watch Kaand Episode 2 (2023) Server 2</h1></a></button>
    <div className="flex flex-col space-y-4 m-8">
    <Rating /></div>
...
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Director:</strong>Dreams Films Web Series</h2>
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Country:</strong> India</h2>
<h2 className="text-medium font-sm text-center dark:text-white text-white "><strong>Starring:</strong> Priya Gamre, Roshni, Komal, Sohail Shock, Anupam, Niranjan.</h2>
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Description:</strong> Kaand web series very soon going to stream on digital streaming platforms Dreams Films app.</h2>

  <h2 className="text-4xl font-bold text-center text-white  ">Watch Offical Trailer</h2>
 
    <iframe className=" aspect-w-16 aspect-h-9  " src="https://sbhight.com/e/pza7agcfm3er.html"  position="relative" height={350} ></iframe>
    </div>
