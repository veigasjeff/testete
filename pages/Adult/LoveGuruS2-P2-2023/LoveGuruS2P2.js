...
const schemaData   = {
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://uwatch4free.vercel.app/Adult/LoveGuruS2-P2-2023/LoveGuruS2P2"
    
  },
  "headline": "LoveGuruS2P2 (2023) | Uwatch4free™",
  "image": "https://uwatch4free.vercel.app/LoveGuruS2-P2-2023.webp",
...
<meta property="og:url" content="https://uwatch4free.vercel.app/Adult/LoveGuruS2-P2-2023/LoveGuruS2P2" />
<meta property="og:image" content="https://uwatch4free.vercel.app/loveGuruS2-P2-2023.webp" />
...
<meta name="twitter:image" content="https://uwatch4free.vercel.app/LoveGuruS2-P2-2023.webp" />
...
<link rel="canonical" href="https://uwatch4free.vercel.app/Adult/LoveGuruS2-P2-2023/" />
   ...
   <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
    <a href="../LoveGuruS2-P2-2023/LGUSR2" > 
      <h1 >Click To Watch LoveGuruS2P2 (2023) Server 2</h1></a></button>
...
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Director:</strong> R Rathod - ULLU Original App</h2>
...
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Description:</strong> This is the story of Rohan and his girlfriend. Rohan goes to his house with his girlfriend to meet his mom. Rohan’s girlfriend’s mother starts liking him, and they both are in love. This is a very romantic drama web series of Ullu.</h2>
