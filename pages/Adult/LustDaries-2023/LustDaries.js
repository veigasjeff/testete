...
const schemaData   = {
  ...
  "headline": "Lust Diaries Pehla Pyar - 2023 | Uwatch4free™",
  ...
  "description": "Uwatch4free™ Lust Diaries Pehla Pyar - 2023 | Watch now the Best TV shows and Movies"
...
const scrollSearch = myKey => {
  ...
  />
     <Head>
     <title>Watch Lust Diaries Pehla Pyar (2023) | Uwatch4free™</title>
...
<link rel="canonical" href="https://uwatch4free.vercel.app/Adult/LustDaries-2023/" />
    ...
    <div className={styles['iframe-container']}>
      <iframe src="https://sbhight.com/e/i7otdkaxlmn1.html" />
    </div>    
    ...
    <a href="../LustDaries-2023/LUDSR2" > 
      <h1 >Click To Watch Lust Diaries Pehla Pyar (2023) Server 2</h1></a></button>
...
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Description:</strong> Lust Diaries Pehla Pyar 2023 WoW Hindi Shorts Web Series.</h2>
  ...
  <div className={styles['iframe-container']}>
      <iframe src="https://sbhight.com/e/efw3a8apejzt.html" />
    </div> 
