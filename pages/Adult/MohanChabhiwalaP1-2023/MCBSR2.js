...
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Director:</strong> Ullu Web Series</h2>
...
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Description:</strong> The plot revolves around a man who is a street vendor. He gets attracted to multiple women and tries his luck.</h2>
