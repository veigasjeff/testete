...
const schemaData   = {
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://uwatch4free.vercel.app/Bollywood/MinusOne-2023/MinusOne"
    
  },
  "headline": "Minus One (2023) | Uwatch4free™",
  "image": "https://uwatch4free.vercel.app/minus-one-2023.webp",
  ...
  "description": "Uwatch4free™ Minus One (2023) | Watch now the Best TV shows and Movies"
...
const scrollSearch = myKey => {
  ...
  />
     <Head>
     <title>Watch Minus One (2023) | Uwatch4free™</title>
...
<meta property="og:title" content="Watch Minus One (2023) | Uwatch4free™" />
<meta property="og:url" content="https://uwatch4free.vercel.app/Bollywood/MinusOne-2023/MinusOne" />
<meta property="og:image" content="https://uwatch4free.vercel.app/minus-one-2023.webp" />
...
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Director:</strong>Sidhanta Mathur, Shubham Yogi</h2>
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Country:</strong> India</h2>
<h2 className="text-medium font-sm text-center dark:text-white text-white "><strong>Starring:</strong> Aisha Ahmed, Ayush Mehra</h2>
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Description:</strong>Minus One - New Chapter is an ode to a relationship that spans several phases of life. Through the relationship of Varun and Ria, we are going to see adulting and growth in the most natural way possible.</h2>

  <h2 className="text-4xl font-bold text-center text-white  ">Watch Offical Trailer</h2>
 
    <iframe className=" aspect-w-16 aspect-h-9  " src="https://sbbrisk.com/e/02fl7mh8ga6d.html"  position="relative"  height={350} ></iframe>
    </div>
