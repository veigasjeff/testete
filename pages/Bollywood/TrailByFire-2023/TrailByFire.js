...
<link rel="canonical" href="https://uwatch4free.vercel.app/Bollywood/TrailByFire-2023/" />
    ...
    <div className={styles['iframe-container']}>
      <iframe src="https://sbhight.com/e/631716zh9uhg.html" />
    </div>    
    ...
    <a href="../TrailByFire-2023/TBFSR2" > 
      <h1 >Click To Watch Trail By Fire (2023) Server 2</h1></a></button>
...
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Description:</strong> Difficult yet resilient journey of two parents - Neelam and Shekhar Krishnamoorthy, trying to seek justice over the last two decades.</h2>
  ...
  <div className={styles['iframe-container']}>
      <iframe src="https://sbhight.com/e/7eylqxel25a3.html" />
    </div> 
