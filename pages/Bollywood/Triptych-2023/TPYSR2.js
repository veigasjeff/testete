...
const schemaData   = {
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://uwatch4free.vercel.app/Bollywood/Triptych-2023/Triptych"
    
  },
  "headline": "Triptych (2023) | Uwatch4free™",
  "image": "https://uwatch4free.vercel.app/Triptych-2023.webp",
  ...
  "description": "Uwatch4free™ Triptych (2023) | Watch now the Best TV shows and Movies"
...
function togglePopup() {
  ...
  />
     <Head>
     <title>Watch Triptych (2023) | Uwatch4free™</title>
...
<meta property="og:title" content="Watch Triptych (2023) | Uwatch4free™" />
<meta property="og:url" content="https://uwatch4free.vercel.app/Bollywood/Triptych-2023/Triptych" />
<meta property="og:image" content="https://uwatch4free.vercel.app/Triptych-2023.webp" />
<meta property="og:image:secure_url" content="https://uwatch4free.vercel.app/" />
<meta property="og:image:width" content="1280" />
<meta property="og:image:height" content="720" />
<meta name="twitter:card" content="summary" />
<meta name="twitter:title" content="Watch Triptych (2023) | Uwatch4free™" />
<meta name="twitter:image" content="https://uwatch4free.vercel.app/Triptych-2023.webp" />
<meta name="description" content="Watch Triptych Full Movie Online on Uwatch4free™, You can also download Triptych (2023) in full HD quality to watch later offline." />
<script src="../../propler/ads.js" defer></script>
<link rel="canonical" href="https://uwatch4free.vercel.app/Bollywood/Triptych-2023/" />
   ...
   <button className=" inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-2 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900  group-hover:bg-opacity-0 " >
    <a href="../Triptych-2023/Triptych" > 
      <h1 >Click To Watch Triptych (2023) Server 1</h1></a></button>
...
<div>
    ...
    <a href="https://www.imdb.com/title/tt20565150/" > 
      <h1 >IDBM Ranking</h1></a></button></div>
      <h2 className=" text-medium font-sm text-center dark:text-white text-white"><strong>Genre:</strong>Drama, Mystery, Thriller.</h2>
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Release year:</strong> 2023</h2>
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Director:</strong>Alba Gil</h2>
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Country:</strong> USA</h2>
<h2 className="text-medium font-sm text-center dark:text-white text-white "><strong>Starring:</strong> Maite Perroni, David Chocarro, Ofelia Medina, Flavio Medina, Claudia Lobo, Nuria Bages, Ana Layevska, Aldo Gallardo, Luciano Vittori, Angel Zermen, Luis Fernández de Eribe, Hector Kotsifakis. Vicky Araico</h2>
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Description:</strong>Triada Title Announcement (Latin America Market) It follows Becca, a forensics expert who, when investigating a murder, realizes that the body of the victim looks exactly like her.</h2>
