...
const schemaData   = {
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://uwatch4free.vercel.app/Hollywood/CarnivalRow-2023/CarnivalRowP2"
    
  },
  "headline": "Carnival Row Episode 2 (2023) Full Movie Online Free | Uwatch4free™",
  ...
  "description": "Uwatch4free™ Carnival Row Episode 2 (2023) Full Movie Online Free | Watch Movies and TV-Series Online Free"
...
function togglePopup() {
  ...
  />
     <Head>
     <title>Watch Carnival Row EP 2 (2023) Full Movie Online Free | Uwatch4free™</title>
...
<meta property="og:title" content="Watch Carnival Row Episode 2 (2023) | Uwatch4free™" />
<meta property="og:url" content="https://uwatch4free.vercel.app/Hollywood/CarnivalRow-2023/CarnivalRowP2" />
...
<meta name="twitter:title" content="Watch Carnival Row Episode 2 (2023) | Uwatch4free™" />
<meta name="twitter:image" content="https://uwatch4free.vercel.app/carnival-row-2023.webp" />
<meta name="description" content="Watch Carnival Row Full Movie Online on Uwatch4free™, You can also download Carnival Row Episode 2 (2023) in full HD quality to watch later offline." />
...
<link rel="canonical" href="https://uwatch4free.vercel.app/Hollywood/CarnivalRow-2023/" />
    ...
    <div className={styles['iframe-container']}>
       <iframe className="  rounded-3xl  mr-8 flex  border-1 border-blue-600 bg-gray-600 p-2 " webkitAllowFullScreen mozallowfullscreen allowFullScreen src="https://sbbrisk.com/e/dmrhuqg74djb.html" />
    </div>    
...
<div className={styles['iframe-container']}>
      <iframe className="  rounded-3xl  mr-8 flex  border-1 border-blue-600 bg-gray-600 p-2 " webkitAllowFullScreen mozallowfullscreen allowFullScreen src="https://sbbrisk.com/e/nhm22cvex1oo.html" />
    </div>   

<h3 className="mb-9 text-bg  text-black-500 text-red-600 text-center xl:px-4 ">*Note: Pls Select the in the Player to Change your Language of your Choice and Setting  to Change the Quality of Video.</h3>
<button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
    <a href="../CarnivalRow-2023/CLRSR2" > 
      <h2 >Click To Watch CarnivalRow Episode 2 (2023) Server 2</h2></a></button>
...
<h2 className="text-medium font-sm text-center dark:text-white text-white "><strong>Starring:</strong> Orlando Bloom, Cara Delevingne, Simon McBurney, Tamzin Merchant, David Gyasi, Karla Crome, Jamie Harris, Andrew Gower, Arty Froushan, Ariyon Bakare, Brian Caspe, Tracey Wilkinson, Waj Ali, James Beaumont, Jay Ali.</h2>
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Description:</strong> A human detective and a fairy rekindle a dangerous affair in a Victorian fantasy world, where the city's uneasy peace collapses when a string of murders reveals an unimaginable monster.</h2>
