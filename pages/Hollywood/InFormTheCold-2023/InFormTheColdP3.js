...
const schemaData   = {
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://uwatch4free.vercel.app/Hollywood/InFormTheCold-2023/InFormTheColdP3"
    
  },
  "headline": "In From the Cold S01E03 (2023) | Uwatch4free™",
  "image": "https://uwatch4free.vercel.app/in-from-the-cold-2023.webp",
  ...
  "description": "Uwatch4free™ In From the Cold S01E03 (2023) | Watch now the Best TV shows and Movies"
...
const scrollSearch = myKey => {
  ...
  />
     <Head>
     <title>Watch In From the Cold S01E03 (2023) | Uwatch4free™</title>
...
<meta property="og:title" content="Watch In From the Cold S01E03 (2023) | Uwatch4free™" />
<meta property="og:url" content="https://uwatch4free.vercel.app/Hollywood/InFormTheCold-2023/InFormTheColdP3" />
<meta property="og:image" content="https://uwatch4free.vercel.app/in-from-the-cold-2023.webp" />
<meta property="og:image:secure_url" content="https://uwatch4free.vercel.app/" />
<meta property="og:image:width" content="1280" />
<meta property="og:image:height" content="720" />
<meta name="twitter:card" content="summary" />
<meta name="twitter:title" content="Watch In From the Cold S01E03 (2023) | Uwatch4free™" />
<meta name="twitter:image" content="https://uwatch4free.vercel.app/in-from-the-cold-2023.webp" />
<meta name="description" content="Watch In Form The Cold Full Movie Online on Uwatch4free™, You can also download In From the Cold S01E03 (2023) in full HD quality to watch later offline." />
...
<link rel="canonical" href="https://uwatch4free.vercel.app/Hollywood/InFormTheCold-2023/" />
      ...
      <div className="bg-[#1a202c]">
        <SkipAds />
    <h1 className="mb-4 py-5 font-bold leading-none tracking-tight text-white  text-center md:text-2xl lg:text-3xl dark:text-white">Watch In From the Cold S01E03 (2023) </h1>

     
    <iframe className="w-full aspect-w-16 aspect-h-9" src="https://sbbrisk.com/e/f7wki6e9l1gn.html" height={550}></iframe>
...
<h2 className=" text-medium font-sm text-center dark:text-white text-white"><strong>Genre:</strong> Fantasy, Drama, Sci-Fi.</h2>
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Release year:</strong> 2023</h2>
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Director:</strong> Joaquín Villalonga</h2>
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Country:</strong> USA</h2>
<h2 className="text-medium font-sm text-center dark:text-white text-white "><strong>Starring:</strong> Margarita Levieva, Cillian O'Sullivan, Lydia Fleming, Charles Brice, Alyona Khmelnitskaya, Amanda Bright, Amanda Bright, Pablo Capuz.</h2>
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Description:</strong> Exposed as an ex-Russian spy, an American single mom must juggle family life and unique shape-shifting skills in a battle against an insidious enemy.</h2>

  <h2 className="text-4xl font-bold text-center text-white  ">Watch Offical Trailer</h2>
 
    
    <iframe className=" aspect-w-16 aspect-h-9  " src="https://sbbrisk.com/e/j8iaurnjvklj.html"  position="relative" height={350} ></iframe>
    </div>

    <div className="flex flex-col py-10  text-blue-600 text-center items-center justify-center">
 
 <h3  className="text-xl font-bold leading-normal mt-0 mb-2 text-blue-600 ">In From the Cold S01E03 (2023) </h3>
