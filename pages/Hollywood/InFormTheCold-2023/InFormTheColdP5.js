...
const schemaData   = {
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://uwatch4free.vercel.app/Hollywood/InFormTheCold-2023/InFormTheColdP5"
    
  },
  "headline": "In From the Cold S01E05 (2023) | Uwatch4free™",
  ...
  "description": "Uwatch4free™ In From the Cold S01E05 (2023) | Watch now the Best TV shows and Movies"
...
const scrollSearch = myKey => {
  ...
  />
     <Head>
     <title>Watch In From the Cold S01E05 (2023) | Uwatch4free™</title>
...
<meta property="og:title" content="Watch In From the Cold S01E05 (2023) | Uwatch4free™" />
<meta property="og:url" content="https://uwatch4free.vercel.app/Hollywood/InFormTheCold-2023/InFormTheColdP5" />
...
<link rel="canonical" href="https://uwatch4free.vercel.app/Hollywood/InFormTheCold-2023/" />
      ...
      <div className="bg-[#1a202c]">
        <SkipAds />
    <h1 className="mb-4 py-5 font-bold leading-none tracking-tight text-white  text-center md:text-2xl lg:text-3xl dark:text-white">Watch In From the Cold S01E05 (2023) </h1>

     
    <iframe className="w-full aspect-w-16 aspect-h-9" src="https://sbbrisk.com/e/1w6fatxpczc6.html" height={550}></iframe>
...
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Description:</strong> Exposed as an ex-Russian spy, an American single mom must juggle family life and unique shape-shifting skills in a battle against an insidious enemy.</h2>
 ...
 <h3  className="text-xl font-bold leading-normal mt-0 mb-2 text-blue-600 ">In From the Cold S01E05 (2023) </h3>
