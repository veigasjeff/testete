...
const schemaData   = {
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://uwatch4free.vercel.app/Hollywood/TheArk-2023/TheArkP1"
    
  },
  "headline": " The Ark (2023) | Uwatch4free™",
  ...
  "description": "Uwatch4free™  The Ark (2023) | Watch now the Best TV shows and Movies"
...
const scrollSearch = myKey => {
  ...
  />
     <Head>
     <title>Watch The Ark S01E01 (2023) | Uwatch4free™</title>
...
<meta property="og:title" content="Watch The Ark S01E01 (2023) | Uwatch4free™" />
...
<meta name="twitter:title" content="Watch The Ark S01E01 (2023) | Uwatch4free™" />
<meta name="twitter:image" content="https://uwatch4free.vercel.app/the-ark-2023.webp" />
<meta name="description" content="Watch The Ark Full Movie Online on Uwatch4free™, You can also download The Ark S01E01 (2023) in full HD quality to watch later offline." />
<script async="async" data-cfasync="false" src="//ophoacit.com/1?z=5720177"></script>
      ...
      <div className="bg-[#1a202c]">
        <SkipAds />
    <h1 className="mb-4 py-5 font-bold leading-none tracking-tight text-white  text-center md:text-2xl lg:text-3xl dark:text-white">Watch The Ark S01E01 (2023) </h1>

     
    <iframe className="w-full aspect-w-16 aspect-h-9" src="https://sbbrisk.com/e/2i6xpbyj2ufo.html" height={550}></iframe>
...
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Director:</strong>Dean Devlin</h2>
...
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Description:</strong> Follows the remaining crew of a spacecraft known as Ark One, who must become the best versions of themselves to stay on course and survive after experiencing a catastrophic event that caused massive destruction and loss of life.</h2>
  ...
  <h2 className="text-4xl font-bold text-center text-white  ">Watch Offical Trailer</h2>
    ...
    <iframe className=" aspect-w-16 aspect-h-9  " src="https://sbbrisk.com/e/5parrcyd21vq.html"  position="relative" height={350} ></iframe>
    </div>

    <div className="flex flex-col py-10  text-blue-600 text-center items-center justify-center">
 
 <h3  className="text-xl font-bold leading-normal mt-0 mb-2 text-blue-600 ">The Ark S01E01 (2023) </h3>
