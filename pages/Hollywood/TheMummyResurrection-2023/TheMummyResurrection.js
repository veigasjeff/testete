...
<link rel="canonical" href="https://uwatch4free.vercel.app/Hollywood/TheMummyResurrection-2023/" />
    ...
    <div className={styles['iframe-container']}>
      <iframe src="https://sbhight.com/e/xjktp7zh2uhq.html" />
    </div>    
    ...
    <a href="../TheMummyResurrection-2023/TMRSR2" > 
      <h1 >Click To Watch The Mummy: Resurrection (2022) Server 2</h1></a></button>
...
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Description:</strong> When an infamous "cursed" Egyptian sarcophagus falls into the hands of unscrupulous huckster Everett Randolph, he becomes obsessed with resurrecting the mummified princess held within it.</h2>
  ...
  <div className={styles['iframe-container']}>
      <iframe src="https://sbhight.com/e/pm0ddlw0hv2e.html" />
    </div>   
