...
const schemaData   = {
  ...
  "headline": "The Rig (2023) | uwatch4free™",
  ...
  "description": "uwatch4free™ The Rig (2023) | Watch now the Best TV shows and Movies"
...
const scrollSearch = myKey => {
  ...
  />
     <Head>
     <title>Watch The Rig (2023) | uwatch4free™</title>
<meta name="robots" content="max-snippet:-1, max-image-preview:large, max-video-preview:-1" />
<meta name="keywords" content="uwatch4free,streaming,latest movies,online tv,latest free movies,watch latest movies online,index of The Rig,The Rig (2023) movie,watch The Rig (2023) movie online,The Rig (2023) movie download,The Rig (2023) movie trailer" />
...
<meta property="og:url" content="https://uwatch4free.vercel.app/Hollywood/TheRig-2023/TheRigP5" />
...
<link rel="canonical" href="https://uwatch4free.vercel.app/Hollywood/TheRig-2023/TheRigP1" />
  ...
  <script src="https://cdn.jsdelivr.net/npm/tw-elements/dist/js/index.min.js"></script>
      ...
      <div class="bg-[#1a202c]">
    <h1 className="mb-4 py-5 font-bold leading-none tracking-tight text-white  text-center md:text-2xl lg:text-3xl dark:text-white">Watch The Rig - Episode 5 </h1>

     
    <iframe className="w-full aspect-w-16 aspect-h-9" src="https://sbhight.com/e/h91evpfgrygn.html" height={550}></iframe>

    
    <h3 className="mb-9 text-bg  text-black-500 text-red-600 text-center xl:px-4 ">*Note: Pls Select the in the Player to Change your Language of your Choice and Setting  to Change the Quality of Video.</h3>
    <div class="flex items-center justify-center">
<div class=" shadow-md hover:shadow-lg space-x-4 focus:shadow-lg" role="group">
...
<div class="inline-flex shadow-md hover:shadow-lg space-x-4 my-5 focus:shadow-lg" role="group">
    ...
    <iframe className="w-full aspect-w-16 aspect-h-9" src="https://sbhight.com/e/d86dncrfd378.html" height={550}></iframe>
...
<h2 className=" text-medium font-sm text-center dark:text-white text-white"><strong>Genre:</strong> Mystery, Drama, Sci-Fi.</h2>
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Release year:</strong> 2023</h2>
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Director:</strong> David Macpherson</h2>
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Country:</strong> USA</h2>
<h2 className="text-medium font-sm text-center dark:text-white text-white "><strong>Starring:</strong> Emily Hampshire, Iain Glen, Calvin Demba, Molly Vevers, Abraham Popoola, Rochenda Sandall, Richard Pepple, Martin Compston, Owen Teale, Stuart McQuarrie, Cameron Fulton.</h2>
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Description:</strong> A group of workers on a remote Scottish oil rig are due to return to the mainland when a mysterious fog enshrouds them and supernatural forces take hold.</h2>

  <h2 className="text-4xl font-bold text-center text-white  ">Watch Offical Trailer</h2>
 

    <iframe className=" aspect-w-16 aspect-h-9  " src="https://sbhight.com/e/3fymkp02idfq.html"  position="relative"  height={350} ></iframe>
    </div>
