...
export default () => {
        ...
        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
          <div class="sm:flex sm:items-start">
            ...
            <div class="mt-5 text-center sm:mt-0 sm:ml-4 sm:text-left">
              ...
              <div class="mt-2">
              <video class="w-full" controls autoPlay loop muted >
  <source src="../../official-trailer.mp4" type="video/mp4" alt="Official Trailer">
        ...
        <Link href="../../Hollywood/Transfusion-2023/Transfusion" className="flex title-font  items-center justify-center text-gray-900">
