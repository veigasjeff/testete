...
const DownloadFYKP1A = () => {
  ...
  <h2 className="text-blue-500  title-font mb-3 my-5 font-bold text-2xl ">
    CLICK TO DOWNLOAD MOVIE YOUNG KINDAICHI (2023)  </h2>
  
    <h2 className="text-blue-500  title-font mb-3 my-5 font-bold text-2xl ">
   Young Kindaichi 1 (2023)  LINK BELOW </h2>
<a href="https://sbhight.com/d/79pxk0663icx.html" target={"_blamk"} id="download_link" > 
...
<h2 className="text-blue-500  title-font mb-3 my-5 font-bold text-2xl ">
  Young Kindaichi 2 (2023)  LINK BELOW </h2>
<a href="https://sbhight.com/d/2487qiha8ek4.html" target={"_blamk"} id="download_link" > 
<button className="relative inline-flex items-center  rounded-3xl justify-center p-0.5 mb-2 mr-2 overflow-hidden text-xl font-bold text-gray-900 rounded-lg group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110 ease-in duration-500 cursor-pointer">  
<span className="relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0 ">
Download Now
</span>
...
<h2 className="text-blue-500  title-font mb-3 my-5 font-bold text-2xl ">
  Young Kindaichi 3 (2023)  LINK BELOW </h2>
<a href="https://sbhight.com/d/9m4npbrhug92.html" target={"_blamk"} id="download_link" > 
<button className="relative inline-flex items-center  rounded-3xl justify-center p-0.5 mb-2 mr-2 overflow-hidden text-xl font-bold text-gray-900 rounded-lg group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110 ease-in duration-500 cursor-pointer">  
<span className="relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0 ">
Download Now
</span>
