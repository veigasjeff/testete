...
export async function getStaticProps() {
  ...
  // Validate data
  const autoArray = Array.isArray(autoData) ? autoData : [];
  return {
    props: {
      autoData: autoArray,
    },
...
export default function auto({ autoData }) {
  ...
  const totalPages = Math.ceil((autoData?.length || 0) / itemsPerPage);

  const handlePageChange = (page) => {
    setCurrentPage(page);
  };

  const currentautoItems = autoData.slice(
  ...
  const NewsSchema = JSON.stringify({
    ...
    name: "World News 24™ – Automobile Section.",
  ...
  const rankMathSchema = JSON.stringify({
    ...
    "@graph": [
      ...
      {
        "@type": "WebSite",
        "@id": "https://worldsnews24.vercel.app/auto#website",
        url: "https://worldsnews24.vercel.app/auto",
        name: "World News 24™ – Automobile Section.",
        publisher: {
          "@type": "Organization",
          "@id": "https://worldsnews24.vercel.app/#organization",
      ...
      {
        "@type": "WebPage",
        "@id": "https://worldsnews24.vercel.app/auto#webpage",
        url: "https://worldsnews24.vercel.app/auto",
        name: "World News 24",
        ...
        mainEntity: [
          {
            "@type": "Article",
            "@id": "https://worldsnews24.vercel.app/auto",
            url: "https://worldsnews24.vercel.app/auto",
    ...
    "@graph": [
      {
        ...
        breadcrumb: {
          "@id": "https://worldsnews24.vercel.app/auto#breadcrumb",
        },
        inLanguage: "en-US",
        potentialAction: [
          {
            "@type": "ReadAction",
            target: ["https://worldsnews24.vercel.app/auto"],
          },
        ],
      },
      {
        ...
        itemListElement: [
          {
            ...
            position: 1,
            name: "World News",
            item: "https://worldsnews24.vercel.app/auto",
          },
        ],
      },
      {
  ...
  return (
    <>
      <Head>
        <title> World News 24™ – Automobile Section.</title>
        ...
        <meta
          ...
          content="World News 24™: Your trusted source for breaking news, global updates, and real-time coverage of politics, business, technology, culture, sports, and more—24/7."
        />
        <link rel="canonical" href="https://worldsnews24.vercel.app/auto" />
        <meta property="og:locale" content="en_US" />
        <meta property="og:type" content="website" />
        <meta
          property="og:title"
          content=" World News 24™ – Automobile Section. "
        />
        <meta
          property="og:url"
          content="https://worldsnews24.vercel.app/auto"
        />
        <meta
      ...
      <div style={styles.container}>
        ...
        <h1 style={styles.title}>World News 24™ Automobile Section.</h1>
        ...
        <ul style={styles.newsList}>
          {currentautoItems.map((autoItem, index) => (
            <li key={index} style={styles.autoItem}>
              <Link
                href={`/auto/${generateSlug(autoItem.title)}`}
              ...
              >
                ...
                >
                  <img
                    src={autoItem.thumbnail || autoItem.image}
                    alt={autoItem.title}
                    style={{
                      height: "200px",
                      width: "100%",
