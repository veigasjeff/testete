...
import Livenews from "../../components/Business";
...
const HomePage = ({ videos }) => {
  ...
  const NewsSchema = JSON.stringify({
    ...
    name: "World News 24™ – Business News Section.",
  ...
  return (
    <div>
      <Head>
        <title> World News 24™ – Business News Section.</title>
       ...
       <meta name="keywords" content="world news 24, world news, united kingdom, united states, australia, canada, europe, asia, japan, china, south america" />
        ...
        <meta
          property="og:title"
          content=" World News 24™ – Business News Section. "
        />
        <meta
          property="og:url"
...
export async function getServerSideProps() {
  const res = await fetch("https://worldsnews24.vercel.app/business.json");
