...
export default function business({ businessData }) {
  ...
  const currentbusinessItems = businessData.slice(
  ...
  const rankMathSchema = JSON.stringify({
    ...
    "@graph": [
      ...
      {
        "@type": "WebSite",
        "@id": "https://worldsnews24.vercel.app/business#website",
        url: "https://worldsnews24.vercel.app/business",
        name: "World News 24™ – Business Section.",
        publisher: {
          "@type": "Organization",
          "@id": "https://worldsnews24.vercel.app/#organization",
      ...
      {
        "@type": "WebPage",
        "@id": "https://worldsnews24.vercel.app/business#webpage",
        url: "https://worldsnews24.vercel.app/business",
        name: "World News 24",
        ...
        mainEntity: [
          {
            "@type": "Article",
            "@id": "https://worldsnews24.vercel.app/business",
            url: "https://worldsnews24.vercel.app/business",
    ...
    "@graph": [
      {
        ...
        breadcrumb: {
          "@id": "https://worldsnews24.vercel.app/business#breadcrumb",
        },
        inLanguage: "en-US",
        potentialAction: [
          {
            "@type": "ReadAction",
            target: ["https://worldsnews24.vercel.app/business"],
          },
        ],
      },
      {
        ...
        itemListElement: [
          {
            ...
            position: 1,
            name: "business",
            item: "https://worldsnews24.vercel.app/business",
          },
        ],
      },
      {
  ...
  return (
    <>
      <Head>
        <title> World News 24™ – Business Section.</title>
        ...
        <meta
          ...
          content="World News 24™: Your trusted source for breaking news, global updates, and real-time coverage of politics, business, Business, culture, sports, and more—24/7."
        />
        <meta
          name="description"
          content="World News 24™: Your trusted source for breaking news, global updates, and real-time coverage of politics, business, Business, culture, sports, and more—24/7."
        />
        <link rel="canonical" href="https://worldsnews24.vercel.app/business" />
        <meta property="og:locale" content="en_US" />
        <meta property="og:type" content="website" />
        <meta
          property="og:title"
          content=" World News 24™ – Business Section. "
        />
        <meta
          property="og:url"
          content="https://worldsnews24.vercel.app/business"
        />
        <meta
      ...
      <div style={styles.container}>
        ...
        <h1 style={styles.title}>World News 24™ Business Section.</h1>
        ...
        <ul style={styles.newsList}>
          {currentbusinessItems.map((businessItem, index) => (
            <li key={index} style={styles.businessItem}>
              <Link
                href={`/business/${generateSlug(businessItem.title)}`}
              ...
              >
                ...
                >
                  <img
                    src={businessItem.thumbnail || businessItem.image}
                  ...
                  <div className="flex flex-col sm:text-left text-center">
                    ...
                    >
                    Date: {businessItem.date} - Time {businessItem.time}
                    </p>
