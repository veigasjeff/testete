...
export default function business({ businessData }) {
  ...
  const rankMathSchema = JSON.stringify({
    ...
    "@graph": [
      ...
      {
        "@type": "WebSite",
        "@id": "http://localhost:3000/business#website",
      ...
      {
        "@type": "WebPage",
        "@id": "http://localhost:3000/business#webpage",
        url: "http://localhost:3000/business",
        name: "World News 24",
    ...
    "@graph": [
      {
        ...
        breadcrumb: {
          "@id": "http://localhost:3000/business#breadcrumb",
        },
        inLanguage: "en-US",
        potentialAction: [
          {
            "@type": "ReadAction",
            target: ["http://localhost:3000/business"],
          },
        ],
      },
      {
        ...
        itemListElement: [
          {
            ...
            position: 1,
            name: "business",
            item: "http://localhost:3000/business",
          },
        ],
      },
      {
    ...
    <>
      <Head>
        ...
        <meta
          ...
          content="World News 24™: Your trusted source for breaking news, global updates, and real-time coverage of politics, business, Business, culture, sports, and more—24/7."
        />
        <link rel="canonical" href="http://localhost:3000/business" />
        ...
        <meta
          property="og:url"
          content="http://localhost:3000/business"
        />
        <meta
