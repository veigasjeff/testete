...
export async function getStaticProps() {
  ...
  // Validate data
  const crimeArray = Array.isArray(crimeData) ? crimeData : [];
  return {
    props: {
      crimeData: crimeArray,
    },
  };
}

export default function crime({ crimeData }) {
  ...
  const totalPages = Math.ceil((crimeData?.length || 0) / itemsPerPage);

  const handlePageChange = (page) => {
    setCurrentPage(page);
  };

  const currentcrimeItems = crimeData.slice(
  ...
  const NewsSchema = JSON.stringify({
    ...
    name: "World News 24™ – Crime Section.",
    ...
    "@graph": [
      {
        ...
        breadcrumb: {
          "@id": "https://worldsnews24.vercel.app/crime#breadcrumb",
        },
        inLanguage: "en-US",
        potentialAction: [
          {
            "@type": "ReadAction",
            target: ["https://worldsnews24.vercel.app/crime"],
          },
        ],
      },
      {
        ...
        itemListElement: [
          {
            ...
            position: 1,
            name: "World News",
            item: "https://worldsnews24.vercel.app/crime",
          },
        ],
      },
      {
  ...
  return (
    <>
      <Head>
        <title> World News 24™ – Crime Section.</title>
        ...
        <meta
          ...
          content="World News 24™: Your trusted source for breaking news, global updates, and real-time coverage of politics, business, technology, culture, sports, and more—24/7."
        />
        <link rel="canonical" href="https://worldsnews24.vercel.app/crime" />
        <meta property="og:locale" content="en_US" />
        <meta property="og:type" content="website" />
        <meta property="og:title" content=" World News 24™ – Crime Section. " />
        <meta
          property="og:url"
        ...
        <meta
          ...
          content=" World News 24™ – Crime Section. "
        />
        <meta
          property="og:image"
        ...
        <meta name="twitter:title" content=" World News 24™ – Crime Section." />
        <meta
      ...
      <div style={styles.container}>
        ...
        <h1 style={styles.title}>World News 24™ Crime Section.</h1>
        ...
        <ul style={styles.newsList}>
          {currentcrimeItems.map((crimeItem, index) => (
            <li key={index} style={styles.crimeItem}>
              <Link
                href={`/crime/${generateSlug(crimeItem.title)}`}
              ...
              >
                ...
                >
                  <img
                    src={crimeItem.thumbnail || crimeItem.image}
                    alt={crimeItem.title}
                    style={{
                      height: "200px",
                      width: "100%",
