...
export async function getStaticProps() {
  ...
  // Validate data
  const documentaryArray = Array.isArray(documentaryData)
    ? documentaryData
    : [];
  return {
    props: {
      documentaryData: documentaryArray,
    },
  };
}

export default function documentary({ documentaryData }) {
  ...
  const totalPages = Math.ceil((documentaryData?.length || 0) / itemsPerPage);

  const handlePageChange = (page) => {
    setCurrentPage(page);
  };

  const currentdocumentaryItems = documentaryData.slice(
  ...
  const NewsSchema = JSON.stringify({
    ...
    name: "World News 24™ – Documentary Section.",
  ...
  const rankMathSchema = JSON.stringify({
    ...
    "@graph": [
      ...
      {
        "@type": "WebSite",
        "@id": "https://worldsnews24.vercel.app/documentary#website",
        url: "https://worldsnews24.vercel.app/documentary",
        name: "World News 24™ – Documentary Section.",
        publisher: {
          "@type": "Organization",
          "@id": "https://worldsnews24.vercel.app/#organization",
      ...
      {
        "@type": "WebPage",
        "@id": "https://worldsnews24.vercel.app/documentary#webpage",
        url: "https://worldsnews24.vercel.app/documentary",
        name: "World News 24",
        ...
        mainEntity: [
          {
            "@type": "Article",
            "@id": "https://worldsnews24.vercel.app/documentary",
            url: "https://worldsnews24.vercel.app/documentary",
    ...
    "@graph": [
      {
        ...
        breadcrumb: {
          "@id": "https://worldsnews24.vercel.app/documentary#breadcrumb",
        },
        inLanguage: "en-US",
        potentialAction: [
          {
            "@type": "ReadAction",
            target: ["https://worldsnews24.vercel.app/documentary"],
          },
        ],
      },
      {
        ...
        itemListElement: [
          {
            ...
            position: 1,
            name: "World News",
            item: "https://worldsnews24.vercel.app/documentary",
          },
        ],
      },
      {
  ...
  return (
    <>
      <Head>
        <title> World News 24™ – Documentary Section.</title>
        ...
        <link
          rel="canonical"
          href="https://worldsnews24.vercel.app/documentary"
        />
        <meta property="og:locale" content="en_US" />
        <meta property="og:type" content="website" />
        <meta
          property="og:title"
          content=" World News 24™ – Documentary Section. "
        />
        <meta
          property="og:url"
          content="https://worldsnews24.vercel.app/documentary"
        />
        <meta
      ...
      <div style={styles.container}>
        ...
        <h1 style={styles.title}>World News 24™ Documentary Section.</h1>
        ...
        <ul style={styles.newsList}>
          {currentdocumentaryItems.map((documentaryItem, index) => (
            <li key={index} style={styles.documentaryItem}>
              <Link
                href={`/documentary/${generateSlug(documentaryItem.title)}`}
              ...
              >
                ...
                >
                  <img
                    src={documentaryItem.thumbnail || documentaryItem.image}
                    alt={documentaryItem.title}
                    style={{
                      height: "200px",
                      width: "100%",
                      objectFit: "cover",
