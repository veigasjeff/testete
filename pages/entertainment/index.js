...
import Livenews from "../../components/Entertainment";
...
const HomePage = ({ videos }) => {
  ...
  const NewsSchema = JSON.stringify({
    ...
    name: "World News 24™ – Entertainment News Section.",
  ...
  const rankMathSchema = JSON.stringify({
    ...
    "@graph": [
      ...
      {
        "@type": "WebSite",
        "@id": "https://worldsnews24.vercel.app/entertainment#website",
        url: "https://worldsnews24.vercel.app/entertainment",
        name: "World News 24™ – Entertainment News Section.",
        publisher: {
          "@type": "Organization",
          "@id": "https://worldsnews24.vercel.app/#organization",
      ...
      {
        "@type": "WebPage",
        "@id": "https://worldsnews24.vercel.app/entertainment#webpage",
        url: "https://worldsnews24.vercel.app/entertainment",
        name: "World News 24",
        ...
        mainEntity: [
          {
            "@type": "Article",
            "@id": "https://worldsnews24.vercel.app/entertainment",
            url: "https://worldsnews24.vercel.app/entertainment",
    ...
    "@graph": [
      {
        ...
        "breadcrumb": {
          "@id": "https://worldsnews24.vercel.app/entertainment#breadcrumb",
        },
        "inLanguage": "en-US",
        "potentialAction": [
          {
            "@type": "ReadAction",
            "target": ["https://worldsnews24.vercel.app/entertainment"],
          },
        ],
      },
      {
        ...
        "itemListElement": [
          {
            ...
            "position": 1,
            "name": "World News",
            "item": "https://worldsnews24.vercel.app/entertainment",
          },
        ],
      },
      {
  ...
  return (
    <div>
      <Head>
        <title> World News 24™ – Entertainment News Section.</title>
      ...
      <meta name="keywords" content="world news 24, world news, united kingdom, united states, australia, canada, europe, asia, japan, china, south america" />
        ...
        <link
          rel="canonical"
          href="https://worldsnews24.vercel.app/entertainment"
        />
        <meta property="og:locale" content="en_US" />
        <meta property="og:type" content="website" />
        <meta
          property="og:title"
          content=" World News 24™ – Entertainment News Section. "
        />
        <meta
          property="og:url"
          content="https://worldsnews24.vercel.app/entertainment"
        />
        <meta
...
export async function getServerSideProps() {
  const res = await fetch("https://worldsnews24.vercel.app/entertainment.json");
