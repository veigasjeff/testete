...
export async function getStaticProps() {
  ...
  // Validate data
  const fitnessArray = Array.isArray(fitnessData) ? fitnessData : [];
  return {
    props: {
...
export default function fitness({ fitnessData }) {
  ...
  const currentfitnessItems = fitnessData.slice(
  ...
  const rankMathSchema = JSON.stringify({
    ...
    "@graph": [
      ...
      {
        "@type": "WebSite",
        "@id": "https://worldsnews24.vercel.app/fitness#website",
        url: "https://worldsnews24.vercel.app/fitness",
        name: "World News 24™ – Fitness Section.",
        publisher: {
          "@type": "Organization",
          "@id": "https://worldsnews24.vercel.app/#organization",
      ...
      {
        "@type": "WebPage",
        "@id": "https://worldsnews24.vercel.app/fitness#webpage",
        url: "https://worldsnews24.vercel.app/fitness",
        name: "World News 24",
        ...
        mainEntity: [
          {
            "@type": "Article",
            "@id": "https://worldsnews24.vercel.app/fitness",
            url: "https://worldsnews24.vercel.app/fitness",
    ...
    "@graph": [
      {
        ...
        breadcrumb: {
          "@id": "https://worldsnews24.vercel.app/fitness#breadcrumb",
        },
        inLanguage: "en-US",
        potentialAction: [
          {
            "@type": "ReadAction",
            target: ["https://worldsnews24.vercel.app/fitness"],
          },
        ],
      },
      {
        ...
        itemListElement: [
          {
            ...
            position: 1,
            name: "fitness",
            item: "https://worldsnews24.vercel.app/fitness",
          },
        ],
      },
      {
  ...
  return (
    <>
      <Head>
        <title> World News 24™ – Fitness Section.</title>
        ...
        <meta
          ...
          content="World News 24™: Your trusted source for breaking news, global updates, and real-time coverage of politics, business, Fitness, culture, sports, and more—24/7."
        />
        <meta
          name="description"
          content="World News 24™: Your trusted source for breaking news, global updates, and real-time coverage of politics, business, Fitness, culture, sports, and more—24/7."
        />
        <link rel="canonical" href="https://worldsnews24.vercel.app/fitness" />
        <meta property="og:locale" content="en_US" />
        <meta property="og:type" content="website" />
        <meta
          property="og:title"
          content=" World News 24™ – Fitness Section. "
        />
        <meta
          property="og:url"
          content="https://worldsnews24.vercel.app/fitness"
        />
        <meta
      ...
      <div style={styles.container}>
        ...
        <h1 style={styles.title}>World News 24™ Fitness Section.</h1>
        ...
        <ul style={styles.newsList}>
          {currentfitnessItems.map((fitnessItem, index) => (
            <li key={index} style={styles.fitnessItem}>
              <Link
                href={`/fitness/${generateSlug(fitnessItem.title)}`}
              ...
              >
                ...
                >
                  <img
                    src={fitnessItem.thumbnail || fitnessItem.image}
                    alt={fitnessItem.title}
                    // style={{
                    //   height: "200px",
                    //   width: "100%",
                    //   objectFit: "cover",
                  ...
                  <div className="flex flex-col sm:text-left text-center">
                    ...
                    >
                   Date: {fitnessItem.date} - Time {fitnessItem.time}
                    </p>
                    <p style={styles.cardDescription} className="text-gray-600">
                      {fitnessItem.description}
                    </p>
                  </div>
                </div>
              </Link>
