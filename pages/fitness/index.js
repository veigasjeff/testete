...
export default function fitness({ fitnessData }) {
  ...
  const rankMathSchema = JSON.stringify({
    ...
    "@graph": [
      ...
      {
        "@type": "WebSite",
        "@id": "http://localhost:3000/fitness#website",
      ...
      {
        "@type": "WebPage",
        "@id": "http://localhost:3000/fitness#webpage",
        url: "http://localhost:3000/fitness",
        name: "World News 24",
        ...
        mainEntity: [
          {
            "@type": "Article",
            "@id": "http://localhost:3000/fitness",
            url: "http://localhost:3000/fitness",
    ...
    "@graph": [
      {
        ...
        breadcrumb: {
          "@id": "http://localhost:3000/fitness#breadcrumb",
        },
        inLanguage: "en-US",
        potentialAction: [
          {
            "@type": "ReadAction",
            target: ["http://localhost:3000/fitness"],
          },
        ],
      },
      {
        ...
        itemListElement: [
          {
            ...
            position: 1,
            name: "fitness",
            item: "http://localhost:3000/fitness",
          },
        ],
      },
      {
    ...
    <>
      <Head>
        ...
        <meta
          ...
          content="World News 24™: Your trusted source for breaking news, global updates, and real-time coverage of politics, business, Fitness, culture, sports, and more—24/7."
        />
        <link rel="canonical" href="http://localhost:3000/fitness" />
        ...
        <meta
          property="og:url"
          content="http://localhost:3000/fitness"
        />
        <meta
