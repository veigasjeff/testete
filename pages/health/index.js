...
import Livenews from "../../components/Health";
...
const HomePage = ({ videos }) => {
  ...
  const NewsSchema = JSON.stringify({
    ...
    name: "World News 24™ – Health News Section.",
  ...
  const rankMathSchema = JSON.stringify({
    ...
    "@graph": [
      ...
      {
        "@type": "WebSite",
        "@id": "https://worldsnews24.vercel.app/health#website",
        url: "https://worldsnews24.vercel.app/health",
        name: "World News 24™ – Health News Section.",
        publisher: {
          "@type": "Organization",
          "@id": "https://worldsnews24.vercel.app/#organization",
      ...
      {
        "@type": "WebPage",
        "@id": "https://worldsnews24.vercel.app/health#webpage",
        url: "https://worldsnews24.vercel.app/health",
        name: "World News 24",
        ...
        mainEntity: [
          {
            "@type": "Article",
            "@id": "https://worldsnews24.vercel.app/health",
            url: "https://worldsnews24.vercel.app/health",
    ...
    "@graph": [
      {
        ...
        "breadcrumb": {
          "@id": "https://worldsnews24.vercel.app/health#breadcrumb",
        },
        "inLanguage": "en-US",
        "potentialAction": [
          {
            "@type": "ReadAction",
            "target": ["https://worldsnews24.vercel.app/health"],
          },
        ],
      },
      {
        ...
        "itemListElement": [
          {
            ...
            "position": 1,
            "name": "World News",
            "item": "https://worldsnews24.vercel.app/health",
          },
        ],
      },
      {
  ...
  return (
    <div>
      <Head>
        <title> World News 24™ – Health News Section.</title>
      ...
      <meta name="keywords" content="world news 24, world news, united kingdom, united states, australia, canada, europe, asia, japan, china, south america" />
        ...
        <meta
          ...
          content="World News 24™: Your trusted source for breaking news, global updates, and real-time coverage of politics, business, technology, culture, sports, and more—24/7."
        />
        <link rel="canonical" href="https://worldsnews24.vercel.app/health" />
        <meta property="og:locale" content="en_US" />
        <meta property="og:type" content="website" />
        <meta
          property="og:title"
          content=" World News 24™ – Health News Section. "
        />
        <meta
          property="og:url"
          content="https://worldsnews24.vercel.app/health"
        />
        <meta
...
export async function getServerSideProps() {
  const res = await fetch("https://worldsnews24.vercel.app/health.json");
