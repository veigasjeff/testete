  ...
  return (
    <>
      ...
      <div style={styles.container}>
        ...
        <div
          className="w-full sm:w-[100%] flex flex-col items-center justify-center p-5 bg-blue-600 text-white text-center sm:ml-5 rounded-lg mt-5 sm:mt-0"
          style={{ textShadow: "1px 1px 5px #000", marginTop: "50px" }}
        >
          <h1
            className="text-3xl sm:text-5xl font-bold mb-4"
            style={{ textShadow: "1px 1px 5px #000" }}
          >
            Welcome to World News 24™
          </h1>
          <p
