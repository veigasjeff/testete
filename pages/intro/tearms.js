...
<Script src="../../propler/ads.js" defer />
  ...
  <div className="flex flex-wrap">
    <div className="grow-0 shrink-0 basis-auto mb-12 md:mb-0 w-full  px-3 lg:px-6">
      ...
      <p className="font-bold mb-2">Using Uwatch4free</p>
      ...
      Uwatch4free is working according to DMCA, so if you need to remove any content from the website, you can contact us @ <a className="font-bold text-blue-500 mb-6" href="mailto:drtrailer@gmail.com">drtrailer2022@gmail.com</a>.
      </p>
