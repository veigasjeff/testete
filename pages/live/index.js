...
export default function live({ liveData }) {
  ...
  const rankMathSchema = JSON.stringify({
    ...
    "@graph": [
      ...
      {
        "@type": "WebSite",
        "@id": "http://localhost:3000/live#website",
      ...
      {
        "@type": "WebPage",
        "@id": "http://localhost:3000/live#webpage",
        url: "http://localhost:3000/live",
        name: "World News 24",
    ...
    "@graph": [
      {
        ...
        breadcrumb: {
          "@id": "http://localhost:3000/live#breadcrumb",
        },
        inLanguage: "en-US",
        potentialAction: [
          {
            "@type": "ReadAction",
            target: ["http://localhost:3000/live"],
          },
        ],
      },
      {
    ...
    <>
      <Head>
        ...
        <meta
          ...
          content="World News 24™: Your trusted source for breaking news, global updates, and real-time coverage of politics, business, Live News, culture, sports, and more—24/7."
        />
        <link rel="canonical" href="http://localhost:3000/live" />
        ...
        <meta
          property="og:url"
          content="http://localhost:3000/live"
        />
        <meta
