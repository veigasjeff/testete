...
export default function live({ liveData }) {
  ...
  const totalPages = Math.ceil((liveData?.length || 0) / itemsPerPage);

  const handlePageChange = (page) => {
    setCurrentPage(page);
  };

  const currentliveItems = liveData.slice(
  ...
  const NewsSchema = JSON.stringify({
    ...
    sameAs: [
      ...
      "https://twitter.com/live24",
      "https://www.youtube.com/@News24thinkfirst",
      "https://www.instagram.com/live24official/",
    ],
    logo: {
      "@type": "ImageObject",
  ...
  const rankMathSchema = JSON.stringify({
    ...
    "@graph": [
      ...
      {
        "@type": "WebSite",
        "@id": "https://worldsnews24.vercel.app/live#website",
        url: "https://worldsnews24.vercel.app/live",
        name: "World News 24™ – Live News Section.",
        publisher: {
          "@type": "Organization",
          "@id": "https://worldsnews24.vercel.app/#organization",
      ...
      {
        "@type": "WebPage",
        "@id": "https://worldsnews24.vercel.app/live#webpage",
        url: "https://worldsnews24.vercel.app/live",
        name: "World News 24",
        ...
        mainEntity: [
          {
            "@type": "Article",
            "@id": "https://worldsnews24.vercel.app/live",
            url: "https://worldsnews24.vercel.app/live",
    ...
    "@graph": [
      {
        ...
        breadcrumb: {
          "@id": "https://worldsnews24.vercel.app/live#breadcrumb",
        },
        inLanguage: "en-US",
        potentialAction: [
          {
            "@type": "ReadAction",
            target: ["https://worldsnews24.vercel.app/live"],
          },
        ],
      },
      {
        ...
        itemListElement: [
          {
            ...
            position: 1,
            name: "live",
            item: "https://worldsnews24.vercel.app/live",
          },
        ],
      },
      {
    ...
    <>
      <Head>
        ...
        <meta
          ...
          content="World News 24™: Your trusted source for breaking news, global updates, and real-time coverage of politics, business, Live News, culture, sports, and more—24/7."
        />
        <meta
          name="description"
          content="World News 24™: Your trusted source for breaking news, global updates, and real-time coverage of politics, business, Live News, culture, sports, and more—24/7."
        />
        <link rel="canonical" href="https://worldsnews24.vercel.app/live" />
        ...
        <meta
          property="og:url"
          content="https://worldsnews24.vercel.app/live"
        />
        <meta
      ...
      <div style={styles.container}>
        ...
        <h1 style={styles.title}>World News 24™ International News Section.</h1>
        ...
        <ul style={styles.newsList}>
          {currentliveItems.map((liveItem, index) => (
            <li key={index} style={styles.liveItem}>
              <Link
                href={`/live/${generateSlug(liveItem.title)}`}
              ...
              >
                ...
                >
                  <img
                    src={liveItem.thumbnail || liveItem.image}
                    alt={liveItem.title}
                    // style={{
                    //   height: "200px",
                    //   width: "100%",
