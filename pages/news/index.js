...
export default function News({ newsData }) {
  ...
  const rankMathSchema = JSON.stringify({
    ...
    "@graph": [
      ...
      {
        "@type": "WebSite",
        "@id": "http://localhost:3000/news#website",
      ...
      {
        "@type": "WebPage",
        "@id": "http://localhost:3000/news#webpage",
        url: "http://localhost:3000/news",
        name: "World News 24",
    ...
    "@graph": [
      {
        ...
        breadcrumb: {
          "@id": "http://localhost:3000/news#breadcrumb",
        },
        inLanguage: "en-US",
        potentialAction: [
          {
    ...
    <>
      <Head>
        ...
        <meta
          ...
          content="World News 24™: Your trusted source for breaking news, global updates, and real-time coverage of politics, business, International News, culture, sports, and more—24/7."
        />
        <link rel="canonical" href="http://localhost:3000/news" />
        ...
        <meta
          property="og:url"
          content="http://localhost:3000/news"
        />
        <meta
