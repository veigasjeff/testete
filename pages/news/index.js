...
export default function News({ newsData }) {
  ...
  const NewsSchema = JSON.stringify({
    ...
    name: "World News 24™ – International News Section.",
    url: "https://worldsnews24.vercel.app",
    sameAs: [
      "https://www.facebook.com/news24channel",
      "https://twitter.com/news24",
      "https://www.youtube.com/@News24thinkfirst",
      "https://www.instagram.com/news24official/",
    ],
    logo: {
      "@type": "ImageObject",
  ...
  const rankMathSchema = JSON.stringify({
    ...
    "@graph": [
      ...
      {
        "@type": "WebSite",
        "@id": "https://worldsnews24.vercel.app/news#website",
        url: "https://worldsnews24.vercel.app/news",
        name: "World News 24™ – International News Section.",
        publisher: {
          "@type": "Organization",
          "@id": "https://worldsnews24.vercel.app/#organization",
      ...
      {
        "@type": "WebPage",
        "@id": "https://worldsnews24.vercel.app/news#webpage",
        url: "https://worldsnews24.vercel.app/news",
        name: "World News 24",
        ...
        mainEntity: [
          {
            "@type": "Article",
            "@id": "https://worldsnews24.vercel.app/news",
            url: "https://worldsnews24.vercel.app/news",
    ...
    "@graph": [
      {
        ...
        breadcrumb: {
          "@id": "https://worldsnews24.vercel.app/news#breadcrumb",
        },
        inLanguage: "en-US",
        potentialAction: [
          {
            "@type": "ReadAction",
            target: ["https://worldsnews24.vercel.app/news"],
          },
        ],
      },
      {
        ...
        itemListElement: [
          {
            ...
            position: 1,
            name: "news",
            item: "https://worldsnews24.vercel.app/news",
          },
        ],
      },
      {
  ...
  return (
    <>
      <Head>
        <title> World News 24™ – International News Section.</title>
        ...
        <meta
          ...
          content="World News 24™: Your trusted source for breaking news, global updates, and real-time coverage of politics, business, International News, culture, sports, and more—24/7."
        />
        <meta
          name="description"
          content="World News 24™: Your trusted source for breaking news, global updates, and real-time coverage of politics, business, International News, culture, sports, and more—24/7."
        />
        <link rel="canonical" href="https://worldsnews24.vercel.app/news" />
        <meta property="og:locale" content="en_US" />
        <meta property="og:type" content="website" />
        <meta
          property="og:title"
          content=" World News 24™ – International News Section. "
        />
        <meta
          property="og:url"
          content="https://worldsnews24.vercel.app/news"
        />
        <meta
        ...
        <ul style={styles.newsList}>
          {currentNewsItems.map((newsItem, index) => (
            <li key={index} style={styles.newsItem}>
              <Link
                href={`/news/${generateSlug(newsItem.title)}`}
              ...
              >
                ...
                >
                  <img
                    src={newsItem.thumbnail || newsItem.image}
                    alt={newsItem.title}
                    // style={{
                    //   height: "200px",
                    //   width: "100%",
