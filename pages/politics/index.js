...
import Livenews from "../../components/Politics";
...
const HomePage = () => {
  ...
  const NewsSchema = JSON.stringify({
    ...
    "name": "World News 24™ – Politics News Section.",
  ...
  return (
    <div>
    <Head>
        <title> World News 24™ – Politics News Section.</title>
        ...
        <meta
          property="og:title"
          content=" World News 24™ – Politics News Section. "
        />
        <meta property="og:url" content="https://worldsnews24.vercel.app/politics" />
        <meta
