...
const HomePage = ({ videos }) => {
  ...
  const NewsSchema = JSON.stringify({
    ...
    name: "World News 24™ – Shopping News Section.",
  ...
  return (
    <div>
      <Head>
        <title> World News 24™ – Shopping News Section.</title>
        ...
        <link
          rel="canonical"
          href="https://worldsnews24.vercel.app/shopping "
        />
        <meta property="og:locale" content="en_US" />
        <meta property="og:type" content="website" />
        <meta
          property="og:title"
          content=" World News 24™ – Shopping News Section. "
        />
        <meta
          property="og:url"
...
export async function getServerSideProps() {
  const res = await fetch("https://worldsnews24.vercel.app/shopping.json");
