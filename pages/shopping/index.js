...
export async function getStaticProps() {
  ...
  // Validate data
  const shoppingArray = Array.isArray(shoppingData) ? shoppingData : [];
  return {
    props: {
      shoppingData: shoppingArray,
    },
  };
}

export default function shopping({ shoppingData }) {
  ...
  const totalPages = Math.ceil((shoppingData?.length || 0) / itemsPerPage);

  const handlePageChange = (page) => {
    setCurrentPage(page);
  };

  const currentshoppingItems = shoppingData.slice(
  ...
  const NewsSchema = JSON.stringify({
    ...
    name: "World News 24™ – Shopping Section.",
  ...
  const rankMathSchema = JSON.stringify({
    ...
    "@graph": [
      ...
      {
        "@type": "WebSite",
        "@id": "https://worldsnews24.vercel.app/shopping#website",
        url: "https://worldsnews24.vercel.app/shopping",
        name: "World News 24™ – Shopping Section.",
        publisher: {
          "@type": "Organization",
          "@id": "https://worldsnews24.vercel.app/#organization",
      ...
      {
        "@type": "WebPage",
        "@id": "https://worldsnews24.vercel.app/shopping#webpage",
        url: "https://worldsnews24.vercel.app/shopping",
        name: "World News 24",
        ...
        mainEntity: [
          {
            "@type": "Article",
            "@id": "https://worldsnews24.vercel.app/shopping",
            url: "https://worldsnews24.vercel.app/shopping",
    ...
    "@graph": [
      {
        ...
        breadcrumb: {
          "@id": "https://worldsnews24.vercel.app/shopping#breadcrumb",
        },
        inLanguage: "en-US",
        potentialAction: [
          {
            "@type": "ReadAction",
            target: ["https://worldsnews24.vercel.app/shopping"],
          },
        ],
      },
      {
        ...
        itemListElement: [
          {
            ...
            position: 1,
            name: "shopping",
            item: "https://worldsnews24.vercel.app/shopping",
          },
        ],
      },
      {
  ...
  return (
    <>
      <Head>
        <title> World News 24™ – Shopping Section.</title>
        ...
        <meta
          ...
          content="World News 24™: Your trusted source for breaking news, global updates, and real-time coverage of politics, business, technology, culture, shopping, and more—24/7."
        />
        <link rel="canonical" href="https://worldsnews24.vercel.app/shopping" />
        <meta property="og:locale" content="en_US" />
        <meta property="og:type" content="website" />
        <meta
          property="og:title"
          content=" World News 24™ – Shopping Section. "
        />
        <meta
          property="og:url"
          content="https://worldsnews24.vercel.app/shopping"
        />
        <meta
      ...
      <div style={styles.container}>
        ...
        <h1 style={styles.title}>World News 24™ Shopping Section.</h1>
        ...
        <ul style={styles.newsList}>
          {currentshoppingItems.map((shoppingItem, index) => (
            <li key={index} style={styles.shoppingItem}>
              <Link
                href={`/shopping/${generateSlug(shoppingItem.title)}`}
              ...
              >
                ...
                >
                  <img
                    src={shoppingItem.thumbnail || shoppingItem.image}
