...
import Livenews from "../../components/Sports";
...
const HomePage = ({ videos }) => {
  ...
  const NewsSchema = JSON.stringify({
    ...
    name: "World News 24™ – Sports News Section.",
  ...
  return (
    <div>
      <Head>
        <title> World News 24™ – Sports News Section.</title>
        ...
        <meta
          property="og:title"
          content=" World News 24™ – Sports News Section. "
        />
        <meta
          property="og:url"
...
export async function getServerSideProps() {
  const res = await fetch("https://worldsnews24.vercel.app/sports.json");
