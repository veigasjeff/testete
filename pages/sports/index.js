...
export async function getStaticProps() {
  ...
  // Validate data
  const sportsArray = Array.isArray(sportsData) ? sportsData : [];
  return {
    props: {
      sportsData: sportsArray,
    },
  };
}

export default function Sports({ sportsData }) {
  ...
  const totalPages = Math.ceil((sportsData?.length || 0) / itemsPerPage);

  const handlePageChange = (page) => {
    setCurrentPage(page);
  };

  const currentsportsItems = sportsData.slice(
  ...
  const NewsSchema = JSON.stringify({
    ...
    name: "World News 24™ – Sports Section.",
    url: "http://localhost:3000",
    sameAs: [
      "https://www.facebook.com/news24channel",
      "https://twitter.com/sport24",
      "https://www.youtube.com/@News24thinkfirst",
      "https://www.instagram.com/sport24official/",
    ],
    logo: {
      "@type": "ImageObject",
  ...
  const rankMathSchema = JSON.stringify({
    ...
    "@graph": [
      ...
      {
        "@type": "WebSite",
        "@id": "http://localhost:3000/sport#website",
      ...
      {
        "@type": "WebPage",
        "@id": "http://localhost:3000/sport#webpage",
        url: "http://localhost:3000/sport",
        name: "World News 24",
    ...
    "@graph": [
      {
        ...
        breadcrumb: {
          "@id": "http://localhost:3000/sport#breadcrumb",
        },
        inLanguage: "en-US",
        potentialAction: [
          {
            "@type": "ReadAction",
            target: ["http://localhost:3000/sport"],
          },
        ],
      },
      {
        ...
        itemListElement: [
          {
            ...
            position: 1,
            name: "sport",
            item: "http://localhost:3000/sport",
          },
        ],
      },
      {
  ...
  return (
    <>
      <Head>
        <title> World News 24™ – Sports Section.</title>
        ...
        <meta
          ...
          content="World News 24™: Your trusted source for breaking news, global updates, and real-time coverage of politics, business, Sports, culture, sports, and more—24/7."
        />
        <meta
          name="description"
          content="World News 24™: Your trusted source for breaking news, global updates, and real-time coverage of politics, business, Sports, culture, sports, and more—24/7."
        />
        <link rel="canonical" href="http://localhost:3000/sport" />
        <meta property="og:locale" content="en_US" />
        <meta property="og:type" content="website" />
        <meta
          property="og:title"
          content=" World News 24™ – Sports Section. "
        />
        <meta
          property="og:url"
          content="http://localhost:3000/sport"
        />
        <meta
      ...
      <div style={styles.container}>
        ...
        <h1 style={styles.title}>World News 24™ Sports Section.</h1>
        ...
        <ul style={styles.newsList}>
          {currentsportsItems.map((sportsItem, index) => (
            <li key={index} style={styles.sportsItem}>
              <Link
                href={`/sports/${generateSlug(sportsItem.title)}`}
              ...
              >
                ...
                >
                  <img
                    src={sportsItem.thumbnail || sportsItem.image}
