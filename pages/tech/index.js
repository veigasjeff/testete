...
export async function getStaticProps() {
  ...
  // Validate data
  const techArray = Array.isArray(techData) ? techData : [];
  return {
    props: {
      techData: techArray,
    },
...
export default function tech({ techData }) {
  ...
  const totalPages = Math.ceil((techData?.length || 0) / itemsPerPage);

  const handlePageChange = (page) => {
    setCurrentPage(page);
  };

  const currenttechItems = techData.slice(
  ...
  const NewsSchema = JSON.stringify({
    ...
    name: "World News 24™ – Technology Section.",
  ...
  const rankMathSchema = JSON.stringify({
    ...
    "@graph": [
      ...
      {
        "@type": "WebSite",
        "@id": "http://localhost:3000/tech#website",
      ...
      {
        "@type": "WebPage",
        "@id": "http://localhost:3000/tech#webpage",
        url: "http://localhost:3000/tech",
        name: "World News 24",
    ...
    "@graph": [
      {
        ...
        breadcrumb: {
          "@id": "http://localhost:3000/tech#breadcrumb",
        },
        inLanguage: "en-US",
        potentialAction: [
          {
            "@type": "ReadAction",
            target: ["http://localhost:3000/tech"],
          },
        ],
      },
      {
  ...
  return (
    <>
      <Head>
        <title> World News 24™ – Technology Section.</title>
        ...
        <meta
          ...
          content="World News 24™: Your trusted source for breaking news, global updates, and real-time coverage of politics, business, technology, culture, sports, and more—24/7."
        />
        <link rel="canonical" href="http://localhost:3000/tech" />
        <meta property="og:locale" content="en_US" />
        <meta property="og:type" content="website" />
        <meta
          property="og:title"
          content=" World News 24™ – Technology Section. "
        />
        <meta
          property="og:url"
          content="http://localhost:3000/tech"
        />
        <meta
      ...
      <div style={styles.container}>
        ...
        <h1 style={styles.title}>World News 24™ Technology Section.</h1>
        ...
        <ul style={styles.newsList}>
          {currenttechItems.map((techItem, index) => (
            <li key={index} style={styles.techItem}>
              <Link
                href={`/tech/${generateSlug(techItem.title)}`}
              ...
              >
                ...
                >
                  <img
                    src={techItem.thumbnail || techItem.image}
                    alt={techItem.title}
                    // style={{
                    //   height: "200px",
                    //   width: "100%",
