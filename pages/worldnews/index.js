...
import Livenews from "../../components/Worldnews";
...
const HomePage = () => {
  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      {
        '@type': 'WebSite',
        '@id': 'https://worldsnews24.vercel.app/worldnews#website',
        url: 'https://worldsnews24.vercel.app/worldnews',
        name: 'World News 24™ – International News Section.',
        publisher: {
          '@type': 'Organization',
          '@id': 'https://worldsnews24.vercel.app/#organization'
      ...
      {
        '@type': 'WebPage',
        '@id': 'https://worldsnews24.vercel.app/worldnews#webpage',
        url: 'https://worldsnews24.vercel.app/worldnews',
        name: 'News',
        ...
        mainEntity: [
          {
            '@type': 'Article',
            '@id': 'https://worldsnews24.vercel.app/worldnews',
            url: 'https://worldsnews24.vercel.app/worldnews',
  ...
  return (
    ...
    <Head>
        ...
        <meta
          ...
          content="World News 24™: Your trusted source for breaking news, global updates, and in-depth analysis from around the world. Stay informed 24/7 with real-time coverage of politics, business, worldnewsnology, culture, and more."
        />
        <meta
          name="description"
          content="World News 24™: Your trusted source for breaking news, global updates, and in-depth analysis from around the world. Stay informed 24/7 with real-time coverage of politics, business, worldnewsnology, culture, and more."
        />
        <link rel="canonical" href="https://worldsnews24.vercel.app/worldnews" />
        ...
        />
        <meta property="og:url" content="https://worldsnews24.vercel.app/worldnews" />
        <meta
