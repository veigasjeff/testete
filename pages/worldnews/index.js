    ...
    "@graph": [
      {
        ...
        "potentialAction": [
          {
            "@type": "ReadAction",
            "target": ["https://worldsnews24.vercel.app/worldnews"],
          },
        ],
      },
      {
        ...
        "itemListElement": [
          {
            ...
            "position": 1,
            "name": "World News",
            "item": "https://worldsnews24.vercel.app/worldnews",
          },
        ],
      },
      {
...
export async function getServerSideProps() {
  const res = await fetch("https://worldsnews24.vercel.app/worldnews.json");
